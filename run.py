...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=False, default='1', help='model id')
    parser.add_argument('--model', type=str, required=False, default='MSGNet',
                        help='model name, options: [RGCN, MSGNet, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, required=False, default='ALFA', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/ALFA/dataset1', help='root path of the data file')
    ...
    parser.add_argument('--num_relations', type=int, default=3, help='')
    parser.add_argument('--agg_method', type=str, default='average', help='sum,average,max,weighted_sum,attention,mlp,conv_fusion')
    # DLinear
